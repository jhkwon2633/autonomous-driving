...
impl Default for LaneTrajectory {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::LaneTrajectory::default())
  }
}

impl rosidl_runtime_rs::Message for LaneTrajectory {
  type RmwMsg = super::msg::rmw::LaneTrajectory;
