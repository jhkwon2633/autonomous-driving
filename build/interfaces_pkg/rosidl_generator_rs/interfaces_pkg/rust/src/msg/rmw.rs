...
#[link(name = "interfaces_pkg__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__interfaces_pkg__msg__LaneTrajectory() -> *const std::ffi::c_void;
}

#[link(name = "interfaces_pkg__rosidl_generator_c")]
extern "C" {
    fn interfaces_pkg__msg__LaneTrajectory__init(msg: *mut LaneTrajectory) -> bool;
    fn interfaces_pkg__msg__LaneTrajectory__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<LaneTrajectory>, size: usize) -> bool;
    fn interfaces_pkg__msg__LaneTrajectory__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<LaneTrajectory>);
    fn interfaces_pkg__msg__LaneTrajectory__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<LaneTrajectory>, out_seq: *mut rosidl_runtime_rs::Sequence<LaneTrajectory>) -> bool;
}

// Corresponds to interfaces_pkg__msg__LaneTrajectory
#[cfg_attr(feature = "serde", derive(Deserialize, Serialize))]
...
impl Default for LaneTrajectory {
  fn default() -> Self {
    unsafe {
      let mut msg = std::mem::zeroed();
      if !interfaces_pkg__msg__LaneTrajectory__init(&mut msg as *mut _) {
        panic!("Call to interfaces_pkg__msg__LaneTrajectory__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for LaneTrajectory {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { interfaces_pkg__msg__LaneTrajectory__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { interfaces_pkg__msg__LaneTrajectory__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { interfaces_pkg__msg__LaneTrajectory__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}

impl rosidl_runtime_rs::Message for LaneTrajectory {
  type RmwMsg = Self;
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> { msg_cow }
  fn from_rmw_message(msg: Self::RmwMsg) -> Self { msg }
}

impl rosidl_runtime_rs::RmwMessage for LaneTrajectory where Self: Sized {
  const TYPE_NAME: &'static str = "interfaces_pkg/msg/LaneTrajectory";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__interfaces_pkg__msg__LaneTrajectory() }
  }
}
